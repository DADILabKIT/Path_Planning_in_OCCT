...
weights_list = [0.001, 0.01, 0.0001]
...
for weight in weights_list:
    ...
    boss_box = BRepPrimAPI_MakeBox(gp_Pnt(600,700,900), 50, 50, 50).Shape()
    a.DisplayShape(boss_box, color='yellow')
    ...
    a.FitAll()
    a.View.Dump(r"nonuniform_onepoint_weight_{}.png".format(weight))
    a.EraseAll()
