...
# m 균일
knots = TColStd_Array1OfReal(1, 5).Length()
...
# 장애물
# Make the sphere a bit larger than the diameter of the cable # 그냥, 그린 장애물
obstacle_radius = diameter * 1.1
middle_pnt = bc.Value(bc.FirstParameter() +
                      ((bc.LastParameter() - bc.FirstParameter()) / 2.5))
