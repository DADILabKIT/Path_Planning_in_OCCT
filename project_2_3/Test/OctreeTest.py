...
tl.mesh.RandomSampling()
t2.mesh.RandomSampling()
t3.mesh.RandomSampling()
t4.mesh.RandomSampling()
t5.mesh.RandomSampling()


grids = GridMap(gp_Pnt(-600, -600, -600), gp_Pnt(600, 600, 600), a, 8**2)
...
oc = Octree(gp_Pnt(-600, -600, -600), gp_Pnt(600, 600, 600), a, 30)
...
ocastar.Run()
print("astar done")
ocastar.DisplayPathBySplinePipe(diameter=1)
